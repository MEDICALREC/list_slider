+ function(e, f, b, j, c, i, k) { /*! Jssor */
    ...
    var a = e.$Jssor$ = new function() {
        ...
        function Jb() {
            if (!I) {
                I = {
                    Pg: "ontouchstart" in e || "createTouch" in f
                };
                var a;
        ...
        g.Eg = function(d, c) {
            if (c) d.style.clip = "rect(" + b.round(c.f) + "px " + b.round(c.o) + "px " + b.round(c.p) + "px " + b.round(c.g) + "px)";
            else {
    ...
    var o = e.$JssorSlideshowFormations$ = new function() {
        ...
        h.Fe = function(d) {
            for (var e = [], a, c = 0; c < d.V; c++)
                for (a = 0; a < d.r; a++) g(e, b.ceil(1e5 * b.random()) % 13, [c, a]);
            return e
        }
    };
        ...
        function k(g, f) {
            ...
            e.Ae = function(b, a) {
                ...
                if (!e.dc[f]) {
                    ...
                    for (var c = 0; c < e.r; c++)
                        for (var d = 0; d < e.V; d++) e.dc[f][d + "," + c] = {
                            f: d * a,
                            o: c * b + b,
                            p: d * a + a,
                            g: c * b
        ...
        function p(A, h, d, v, n, l) {
            ...
            a.c(o, function(h, m) {
                a.c(h, function(G) {
                    ...
                    j[v].Rd = A + F - 1;
                    for (var z = 0; z <= F; z++) {
                        var y = a.rd(f, r, z / F, d.J, d.cc, d.ec, {
                            Y: d.Y,
                            U: n,
                            W: l
                        });
    ...
    var h = e.$JssorSlider$ = function(p, cc) {
            ...
            function T(b, d, e) {
                ...
                a.c(f, function(f) {
                    ...
                    if (j == "caption") {
                        ...
                        if (h == "A") {
                            if (a.i(f, "u") == "image") k = a.zg(f, "IMG");
                            else k = a.z(f, "image", c);
                            if (k) {
                                x = f;
                                a.nb(x, "block");
                                a.bb(x, V);
        ...
        var Fb = g.Zg,
            ...
            R = !g.Ng,
            y, v = a.z(p, "slides", R),
            fb = a.z(p, "loading", R) || a.tb(f),
            Lb = a.z(p, "navigator", R),
            dc = a.z(p, "arrowleft", R),
            ac = a.z(p, "arrowright", R),
            Kb = a.z(p, "thumbnavigator", R),
            mc = a.j(v),
            kc = a.l(v),
            V, Q = [],
            rc = a.O(v);
        ...
        g.Jc && a.e(f, "keydown", function(a) {
            if (a.keyCode == 37) ob(-g.Jc);
            else a.keyCode == 39 && ob(g.Jc)
        });
        var nb = g.Hc;
                ...
                function h(c, d) {
                    ...
                    a.c(o, function(g, h) {
                        ...
                        if (e) {
                            var f = {};
                            if (g == "t") f.ib = e;
                            else if (e.indexOf("%") + 1) f.Kf = a.xc(e) / 100;
                            else f.ib = a.xc(e);
                            b[h] = f
                        }
                    });
